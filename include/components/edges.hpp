...
// // class Edge : public UI::Base {
// // private:
// //     const std::unique_ptr<AnimatedNode> &from;
// //     const std::unique_ptr<AnimatedNode> &to;
// //     float thickness;
// //     bool isDirected;
...
// //     Edges (const std::unique_ptr<AnimatedNode> &from, const std::unique_ptr<AnimatedNode> &to, float thickness = 2.f, bool isDirected = false) :
